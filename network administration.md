...
Многоранговые сети (доменная сеть является управляющим звеном в котором есть один компьютер и все полномочия и доступы на другие компьютеры настраиваюся на одном этом компьютере)
