...
Что ещё может быть в качестве управляемого звена? Любой маршрутизатор. Где можно иметь одноранговую сеть или доменную и настраивать права и доступы на другие компьютера по сети.
