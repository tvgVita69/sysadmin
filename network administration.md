...
Ну примерно так, прораб или строительный инженер должен принести вам типа такой схемы и согласовать с руководителем ИТ расположение розеток компьютерных и телефонных, количество и трассу.  
